...
tx,ty,tz; float sx,sy,sz; float
angle; int choice,choiceRot;
...
for(int i=0;i<8;i++)
{
output[i][0]=input[i][0]+tx; output[i][1]=input[i][1]+ty;
...
glVertex2s(-
1000 ,0); glVertex2s( 1000 ,0); glEnd();
...
cin>>sx>>sy>>sz;
break;
case 3: cout<<"Enter your choice for Rotation aboutaxis:\n1.parallel to Xaxis."
...
cin>>angle; break; case 2:
cout<<"\nENter Rotation angle: ";
cin>>angle; break; case 3:
cout<<"\nENter Rotation angle: ";
cin>>angle; break; default:
break;
}
break; default: break; }
